...
Your Answer: 16 подсетей и 4094 доступных хостов в каждой подсети
...
Your Answer: если имеется ввиду маска подсети из предыдущего вопроса /24 или 255.255.255.0,
то что бы ее разбить на 5 подсетей нужно использовать маску /27 или 255.255.255.224
